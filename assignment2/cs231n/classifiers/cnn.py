...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        fc_out, fc_cache = affine_relu_forward(conv_out, self.params["W2"], self.params["b2"])
        out, cache = affine_forward(fc_out, self.params["W3"], self.params["b3"])
        scores = out
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout3, dw3, db3 = affine_backward(dout, cache)
        dout2, dw2, db2 = affine_relu_backward(dout3, fc_cache)
        dout1, dw1, db1 = conv_relu_pool_backward(dout2, conv_cache)
